...
/**
 * @file This file contains the AI logic for the 'lich_guard' monster type.
 * These are tough minions typically summoned by an Arch-Summoner boss.
 */

/**
 * Handles the AI for a 'lich_guard' monster.
 *
 * This AI is straightforward, functioning as a simple but durable melee attacker.
 * It identifies the closest target (player or ally) and moves towards it.
 * Its primary role is to act as a bodyguard and obstacle.
 *
 * @param monster The lich guard entity to process.
 ...
 */
export const handleLichGuardAI = (
    monster: Monster,
    player: Player,
    allies: Ally[],
